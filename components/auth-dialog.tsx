...
import { User, Mail, Lock, Eye, EyeOff, Loader2, ArrowRight, CheckCircle2, AlertCircle, Link as LinkIcon } from "lucide-react";
            ...
            <>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2 flex items-center gap-2">
                  <LinkIcon className="w-4 h-4 text-[#8b0000]" /> Magic login link (no password)
                </h3>
                <p className="text-sm text-gray-700 mb-4">
                  A magic login link lets you sign in directly from your registered email address—no password needed.
                  If your password reset isn’t working, you can request a magic login link instead.
                </p>
